...
class List extends Component {
    ...
    loadObjects(offset, all, callBack) {
        ...
        var url = server_url + context_path + "api/" + this.props.baseUrl + "?projection=obj_details&page=" + (offset - 1);
            ...
            <Table hover responsive>
                <thead>
                    <Sorter columns={[
                        ...
                        { name: 'Available Qty', sortable: false, param: 'quantity' },
                        ...
                        return (
                            <tr key={obj.id}>
                                ...
                                <td>
                                    ...
                                    {obj.quantity===0?'Out of stock':obj.quantity+' '+(obj.uom===null?'':obj.uom) }
