                                        ...
                                        <table className="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    {this.state.obj.dob && <Moment format="DD MMM YY">{this.state.obj.dob}</Moment>}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                    {this.state.obj.anniversary && <Moment format="DD MMM YY">{this.state.obj.anniversary}</Moment>}
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
