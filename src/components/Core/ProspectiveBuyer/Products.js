...
class Products extends Component {
    state = {
        ...
        products: [],
        selectedProducts: [],
        productsUrl: server_url + context_path + "api/buyer-products/",
        page: {
            number: 0,
            size: 20,
            totalElements: 0,
    ...
    getProducts() {
        ...
        axios.get(this.state.productsUrl + "?size=100000&projection=buyer-products&buyer.id=" + newObj.id + "&type=" + this.state.type)
        .then(res => {
            ...
            if(products && products.length) {
                ...
                products.forEach((prod, idx) => {
                    if(prod.delete) {
                        ...
                        prod.buyerProduct = '/buyer-Product/' + this.state.newObj.id;
