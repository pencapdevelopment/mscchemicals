                        ...
                        <div className="col-md-12">
                            <AppBar position="static" className={`${!this.state.reference ? 'd-none' : ''}`}>
                                <Tabs
                                    ...
                                    <Tab label="List" />
                                    <Tab label="Add Followup" hidden={this.state.editFlag || this.props.readOnly} />
                                    <Tab label="View Followup" hidden={!this.state.editFlag} />
                                </Tabs>
                            </AppBar>
                            <TabPanel value={this.state.activeTab} index={0}>
                                {this.state.repository &&
                                <List baseUrl={this.state.baseUrl} onRef={ref => (this.listTemplateRef = ref)}
                                reference={this.state.reference} repository={this.state.repository} readOnly={this.props.readOnly}
                            ...
                            <TabPanel value={this.state.activeTab} index={1}>
                                ...
                                onSave={(id) => this.saveSuccess(id)} readOnly={this.props.readOnly} onCancel={this.cancelSave}></Add>
                            </TabPanel>
                            <TabPanel value={this.state.activeTab} index={2}>
                                <View baseUrl={this.state.baseUrl} onRef={ref => (this.viewTemplateRef = ref)}  readOnly={this.props.readOnly}
