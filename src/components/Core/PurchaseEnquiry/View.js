...
import PurchaseApproval from '../PurchaseApproval/Approval';
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            ...
                            <TabPanel value={this.state.activeTab} index={4}>
                                <PurchaseApproval repository={this.props.baseUrl} reference={this.state.obj.id} onRef={ref => (this.followupsTemplateRef = ref)} readOnly={this.state.obj.status ==='Converted'}></PurchaseApproval> 
                            </TabPanel>
                        </div>
                    </div>}
                    {this.state.editFlag &&
