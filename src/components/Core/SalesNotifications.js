...
class SalesNotifications extends Component {
    ...
    loadObjects(offset, all, callBack) {
        ...
        var url = server_url + context_path + "api/notifications?url=%25%2Fsales%2F%25&type=NEW_APPROVAL";
        ...
        return (<ContentWrapper>
            ...
            <div className="card b">
                <div className="card-body bb bt">
                    <div className="content-heading">Sales Approval Alerts</div>
                    <div className="row">
