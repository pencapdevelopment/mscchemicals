...
class List extends Component {
    ...
    loadObjects(offset, all, callBack) {
        ...
        var url = server_url + context_path + "api/" + this.props.baseUrl + "?page=" + (offset - 1);
                    ...
                    {this.state.objects.map((obj, i) => {
                        return (
                            <tr key={obj.id}>
                                ...
                                <td>
                                {  this.props.user.role === 'ROLE_ADMIN' && <Button variant="contained" color="inverse" size="xs" onClick={() => this.editObj(i)}>Edit</Button>}
