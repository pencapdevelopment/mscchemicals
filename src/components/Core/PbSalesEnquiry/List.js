...
class List extends Component {
    ...
    loadObjects(offset, all, callBack) {
        ...
        var url = Const.server_url + Const.context_path + "api/" + this.props.baseUrl + "?projection=pb_sales_list&page=" + (offset - 1);
                    ...
                    {this.state.objects.map((obj, i) => {
                        return (
                            <tr key={obj.id}>
                                <td>{i + 1}</td>
                                <td>
                                    <Link to={`/pbsales/${obj.id}`}>
                                        {obj.code}
                                    </Link>
                                </td>
                                <td>
                                    <Link to={`/prospective-buyer/${obj.company.id}`}>
                                        {obj.company.name}
                                    </Link>
                                </td>
                                <td>                                    
